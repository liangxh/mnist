...
def decode_idx3_ubyte(idx3_ubyte_file, n = None):
    ...
    if n: num_images = min(n, num_images)
...
def decode_idx1_ubyte(idx1_ubyte_file, n = None):
    """
    解析idx1文件的通用函数
...
def load_train_images(idx_ubyte_file=train_images_idx3_ubyte_file, n = None):
    """
    ...
    """
    return decode_idx3_ubyte(idx_ubyte_file, n)


def load_train_labels(idx_ubyte_file=train_labels_idx1_ubyte_file, n = None):
    """
...
def load_test_images(idx_ubyte_file=test_images_idx3_ubyte_file, n = None):
    """
...
def load_test_labels(idx_ubyte_file=test_labels_idx1_ubyte_file, n = None):
    """
